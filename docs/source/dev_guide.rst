...
First activate the ``frevas`` Conda environment and install ``pytest``.
...
.. code-block:: console
  ...
  $ make clean
  $ make install
  $ conda list -n frevas --explicit > spec-file.txt
...
Make a new version of frevas in the following steps:
